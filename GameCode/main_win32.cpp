...
void CreateOpenGLWindow( HINSTANCE applicationInstanceHandle )
{
	...
	RECT windowRect = { xOffset + 0, yOffset + 0, xOffset + Henry::WINDOWS_WIDTH, yOffset + Henry::WINDOWS_HEIGHT };		// shifting the windows start position from 0,0(topleft) to 50,50
...
// 	int hCrt = _open_osfhandle((long)handle_out, O_TEXT);
// 	FILE* hf_out = _fdopen(hCrt, "w");
// 	setvbuf(hf_out, NULL, _IONBF, 1);
// 	*stdout = *hf_out;
// 
// 	HANDLE handle_in = GetStdHandle(STD_INPUT_HANDLE);
// 	hCrt = _open_osfhandle((long)handle_in, O_TEXT);
